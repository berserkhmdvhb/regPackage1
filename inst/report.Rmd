...
```{r}
RMSE_ARMA <- rmse(pred, actual)
RMSE_ARMA
```


```{r}
MAE_ARMA <- mae(pred, actual)
MAE_ARMA
```
...
```{r}
RMSE_ARMA <- rmse(pred_cv, actual)
RMSE_ARMA
```


```{r}
MAE_ARMA <- mae(pred_cv, actual)
MAE_ARMA
```
