...
X_train <- insurance_train[, colnames(insurance_train)[colnames(insurance_train) != "outcome"]]
X_test <- insurance_test[, colnames(insurance_test)[colnames(insurance_test) != "outcome"]]
y_train <- as.factor(insurance_train[["outcome"]])
y_test <- as.factor(insurance_test[["outcome"]])
#
```
...
pred_proba_rf_list <- pred_proba_rf |> as.list() |> tail(nrow(insurance_test)) |> unlist()
```
