...
rf <- randomForest(x = X_train, y = y_train, proximity=TRUE)
```
...
```{r}
predict_rf_proba <- predict(rf, X_test, type="prob")
```

```{r}
#pROC::roc(actual ~ predict_rf_proba, plot = TRUE, print.auc = TRUE)
```
